...
// Created by ZENA(TM) Version 1.3.0.0, 8/28/2006, 13:26:53
...
//--------------------------------------
    {
        ...
        {ZIB_DTP_DEV_ID_LSB,ZIB_DTP_DEV_ID_MSB},
        ZIB_DTP_DEV_VER,
        NO_OTHER_DESCRIPTOR_AVAILABLE,
        2,
        { 
            ZIB_DTP_ANALOG_CLUSTER,
            ZIB_DTP_SENSORS_CLUSTER
        }, 
        1,
        { 
            ZIB_DTP_ACTUATORS_CLUSTER
        } 
    }
};
