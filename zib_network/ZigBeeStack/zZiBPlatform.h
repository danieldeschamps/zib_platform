...
implement the Microchip Temperature Sensor demo.  It is designed as a
simple extension to the ZigBee Home Control, Lighting profile.
...
From the ZigBee Home Control, Lighting profile:
...
#ifndef _ZZIBPLATFORM_H_
#define _ZZIBPLATFORM_H_

//******************************************************************************
// Profile
#define MY_PROFILE_ID                       0xFFFF  // ZiB Platform
#define MY_PROFILE_ID_MSB                   0xFF
#define MY_PROFILE_ID_LSB                   0xFF

//******************************************************************************
// Devices

#define TEMPERATURE_SENSOR_DEV_ID      0xfff0   //Temperature Sensor (MCHP)
#define TEMPERATURE_SENSOR_DEV_ID_MSB  0xff
#define TEMPERATURE_SENSOR_DEV_ID_LSB  0xf0
#define TEMPERATURE_SENSOR_DEV_VER     0x00

#define ZIB_DTP_DEV_ID      0xfff1   //ZiB DTP
#define ZIB_DTP_DEV_ID_MSB  0xff
#define ZIB_DTP_DEV_ID_LSB  0xf1
#define ZIB_DTP_DEV_VER     0x00

#define ZIB_THERM_DEV_ID      0xfff2   //ZiB Therm
#define ZIB_THERM_DEV_ID_MSB  0xff
#define ZIB_THERM_DEV_ID_LSB  0xf2
#define ZIB_THERM_DEV_VER     0x00

#define ZIB_HUMIDITY_DEV_ID      0xfff3   //ZiB Humidity
#define ZIB_HUMIDITY_DEV_ID_MSB  0xff
#define ZIB_HUMIDITY_DEV_ID_LSB  0xf3
#define ZIB_HUMIDITY_DEV_VER     0x00
...
#define PROFILE_nwkSecurityLevel            0x00        // TODO: should be 5 when security supported
...
#define ZIB_DTP_ANALOG_CLUSTER     0x30   //ZiB AD Reading values in Volts
#define ZIB_DTP_SENSORS_CLUSTER    0x31   //ZiB Environment Sensor reading (Temperature, humidity, etc)
#define ZIB_DTP_ACTUATORS_CLUSTER  0x32   //ZiB Actuators

#define Temperature_CLUSTER     0x20    //Temperature sensor reading in deg C (MCHP)
...
//------------------------------------------------------------------------------
// CLUSTER_ZIB_DTP_ANALOG: AD reading
#define ATTRIBUTE_ZIB_DTP_ANALOG_VOLTS					0x0000  //AD reading in V
#define ATTRIBUTE_ZIB_DTP_ANALOG_VOLTS_DATATYPE			APL_FRAME_DATA_TYPE_CSTRING

//------------------------------------------------------------------------------
// CLUSTER_ZIB_DTP_SENSORS: SPI/TTL/RS-232 Environment Sensors
#define ATTRIBUTE_ZIB_DTP_SENSORS_TEMPERATURE				0x0000  //Sensor reading (requires a driver)
#define ATTRIBUTE_ZIB_DTP_SENSORS_TEMPERATURE_DATATYPE		APL_FRAME_DATA_TYPE_CSTRING

//------------------------------------------------------------------------------
// CLUSTER_ZIB_DTP_ACTUATORS: Lit leds
#define ATTRIBUTE_ZIB_DTP_ACTUATORS_LED1					0x0000  //LED1 state
#define ATTRIBUTE_ZIB_DTP_ACTUATORS_LED1_DATATYPE			TRANS_UINT8

#define ATTRIBUTE_ZIB_DTP_ACTUATORS_LED2					0x0001  //LED1 state
#define ATTRIBUTE_ZIB_DTP_ACTUATORS_LED2_DATATYPE			TRANS_UINT8

//------------------------------------------------------------------------------
// Cluster Temperature      : Temperature sensor reading
#define Temperature_DegCStr                     0x0000  //Temperature sensor reading in deg C (MCHP)
#define Temperature_DegCStr_DATATYPE            APL_FRAME_DATA_TYPE_CSTRING
...
#if defined(MCHP_C18) // dds: vc6 does not need these checks
...
#endif // #if defined(MCHP_C18)


#endif // #ifndef _ZZIBPLATFORM_H_
